...
export default async function NovelPage({ searchParams }: { searchParams: { page?: string } }) {
  const mangas = await getMangas();
  
  // Only novel for Novel page
  const novelMangas = mangas.filter((m: any) => m.type === 'novel');

  // Sort by updatedAt or createdAt (latest updates)
  const sortedMangas = [...novelMangas].sort((a: any, b: any) => {
